...
if(isset($_POST["envoyer"])){
  ...
  $requete = "SELECT count(*) FROM etudiant where
              LOGIN = '".$username."' and MOT_DE_PASS = '".$password."' ";
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Vous etes sur la page de la connexion des etudiant.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="POST">
                ...
                <div class="text-center">
                 <a href="account.php" class="text-center"><small>Create new account</small>
                 </a>
                </div>
              </form>
            </div>
